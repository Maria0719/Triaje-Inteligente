    ...
    <AppLayout>
      <div className="p-6 space-y-6 max-w-6xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {kpis.map(k => (
            <div key={k.label} className={cn("bg-card rounded-xl border border-border border-l-4 p-4", k.accent)}>
              <div className="flex items-center justify-between">
                <div>
            ...
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={mockStats.patientsByLevel}>
                ...
                <Bar dataKey="count" radius={[6, 6, 0, 0]}>
                  {mockStats.patientsByLevel.map((_, i) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-card rounded-xl border border-border p-5">
            ...
            <div className="space-y-3">
              {mockStats.topComplaints.map((c, i) => (
                <div key={c.complaint} className="flex items-center gap-3">
          ...
          <div className="bg-card rounded-xl border border-border p-5">
            ...
            <div className="space-y-1">
              ...
              {mockStats.waitTimeByLevel.map(w => {
                ...
                return (
                  <div key={w.level} className="grid grid-cols-4 text-sm py-2.5 border-b border-border/50">
